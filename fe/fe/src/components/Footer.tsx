export default function Footer() {
    return (
        <footer className="w-full border-t-[3px] border-[#5A4231] bg-[#F2E3D5] px-4 md:px-8 py-8 shrink-0 flex flex-col md:flex-row justify-between items-center text-[#8A6B53] font-bold text-sm gap-4">
